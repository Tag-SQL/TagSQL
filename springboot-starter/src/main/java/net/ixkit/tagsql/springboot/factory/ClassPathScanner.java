 ...
 */
package net.ixkit.tagsql.springboot.factory;
...
import static net.ixkit.tagsql.springboot.factory.ProviderConfigProcessor.TagSQLBuilder;
...
public class ClassPathScanner extends ClassPathBeanDefinitionScanner {
    ...
    public Set<BeanDefinitionHolder> doScan(String... basePackages) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            definition.getPropertyValues().add("proxy", getRegistry().getBeanDefinition(TagSQLBuilder));
